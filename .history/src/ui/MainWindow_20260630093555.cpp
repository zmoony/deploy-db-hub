...
QWidget *MainWindow::createDeployPage()
{
    ...
    addField(QStringLiteral("目标服务器"), m_deployServer);
    ...
    auto *logCard = PageLayout::makeDeployPlainCard(configColumn, &logBody);
    ...
    logBody->addWidget(PageLayout::makeDeployFieldLabel(QStringLiteral("远程日志"), configColumn));
...
AppSettings settings;
    ...
    PageLayout::applyLighterCardShadow(settingsBox);
